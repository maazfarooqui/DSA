...
//after the loop we check for two condition : if the does not exist any ceil or floor for x in the array. we do so by checking if cl and flr were ever updated in the array or not. if not we change their value to one 
